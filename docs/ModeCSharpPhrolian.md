...
![CSharpPhrolian](ModeCSharpPhrolian.png)

## Diagram

![CSharpPhrolian](CircleModeCSharpPhrolian.png)
...
| Number | Mode | Tonic | Notes | Illustration |
|--------|------|-------|-------|--------------|
| [3497](https://ianring.com/musictheory/scales/3497) | [Phrolian](ModePhrolian.md) | C# | C#, D##, E##, F###, G##, A##, B#, C# | ![CSharpPhrolian](CircleModeCSharpPhrolian.png) |

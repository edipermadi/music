...
![BFlatMajorThirteenth](ChromaticCircleChordBFlatMajorThirteenth.svg)

## Notes

| Position | Notes | Illustration |
|----------|------|--------------|
| RootPosition | Bb,D,F,A,C,Eb,G | ![BFlatMajorThirteenth](ChordBFlatMajorThirteenthRootPosition.png) |
| FirstInversion | D,F,A,C,Eb,G,Bb | ![BFlatMajorThirteenth](ChordBFlatMajorThirteenthFirstInversion.png) |
| SecondInversion | F,A,C,Eb,G,Bb,D | ![BFlatMajorThirteenth](ChordBFlatMajorThirteenthSecondInversion.png) |
| ThirdInversion | A,C,Eb,G,Bb,D,F | ![BFlatMajorThirteenth](ChordBFlatMajorThirteenthThirdInversion.png) |
| FourthInversion | C,Eb,G,Bb,D,F,A | ![BFlatMajorThirteenth](ChordBFlatMajorThirteenthFourthInversion.png) |
| FifthInversion | Eb,G,Bb,D,F,A,C | ![BFlatMajorThirteenth](ChordBFlatMajorThirteenthFifthInversion.png) |
| SixthInversion | G,Bb,D,F,A,C,Eb | ![BFlatMajorThirteenth](ChordBFlatMajorThirteenthSixthInversion.png) |
## Modes

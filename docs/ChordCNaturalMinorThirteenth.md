...
![CNaturalMinorThirteenth](ChromaticCircleChordCNaturalMinorThirteenth.svg)

## Notes

| Position | Notes | Illustration |
|----------|------|--------------|
| RootPosition | C,Eb,G,Bb,D,F,A | ![CNaturalMinorThirteenth](ChordCNaturalMinorThirteenthRootPosition.png) |
| FirstInversion | Eb,G,Bb,D,F,A,C | ![CNaturalMinorThirteenth](ChordCNaturalMinorThirteenthFirstInversion.png) |
| SecondInversion | G,Bb,D,F,A,C,Eb | ![CNaturalMinorThirteenth](ChordCNaturalMinorThirteenthSecondInversion.png) |
| ThirdInversion | Bb,D,F,A,C,Eb,G | ![CNaturalMinorThirteenth](ChordCNaturalMinorThirteenthThirdInversion.png) |
| FourthInversion | D,F,A,C,Eb,G,Bb | ![CNaturalMinorThirteenth](ChordCNaturalMinorThirteenthFourthInversion.png) |
| FifthInversion | F,A,C,Eb,G,Bb,D | ![CNaturalMinorThirteenth](ChordCNaturalMinorThirteenthFifthInversion.png) |
| SixthInversion | A,C,Eb,G,Bb,D,F | ![CNaturalMinorThirteenth](ChordCNaturalMinorThirteenthSixthInversion.png) |
## Modes

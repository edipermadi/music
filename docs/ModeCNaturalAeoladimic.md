...
[CNaturalAeoladimic](ModeCNaturalAeoladimic.md)
...
![CNaturalAeoladimic](ModeCNaturalAeoladimic.png)

## Diagram

![CNaturalAeoladimic](CircleModeCNaturalAeoladimic.png)
...
| Number | Mode | Tonic | Notes | Illustration |
|--------|------|-------|-------|--------------|
| [567](https://ianring.com/musictheory/scales/567) | [Aeoladimic](ModeAeoladimic.md) | C | C, Db, Ebb, Fb, Gbb, A, C | ![CNaturalAeoladimic](CircleModeCNaturalAeoladimic.png) |
